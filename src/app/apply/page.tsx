...
export default function ApplyPage() {
  ...
  const handleResumeUpload = async (file: File | null) => {
    ...
    try {
      ...
      console.error(error);
      alert("Could not read this file. Please upload a text-based resume file.");
    } finally {
    ...
    <div className="min-h-screen flex items-center justify-center p-6 relative overflow-hidden">
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="space-y-2">
            <label className="text-sm font-medium text-slate-300 ml-1">Upload CV (text extraction)</label>
            <input
              type="file"
              accept=".txt,.md,.csv,.json,.rtf,.pdf,.doc,.docx"
            ...
            <p className="text-xs text-slate-400 ml-1">
              {uploadingResume
                ...
                : resumeFileName
                  ...
                  : "Upload your CV to auto-fill the resume summary."}
            </p>
          </div>
